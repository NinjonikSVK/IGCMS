...
<!--	<li class="dropdown">
	...
	<?php/*
		if ($Level > "1"){
				echo '
					<li class="dropdown">
						<a href="#" class="btn btn-rose btn-round" data-toggle="dropdown">
							<i class="material-icons">build</i> Administrácia
							<b class="caret"></b>
						</a>
						<ul class="dropdown-menu dropdown-with-icons">
							<li>
								<a href="members">
									<i class="material-icons">account_circle</i> Uživatelia
								</a>
							</li>
							<li><a href="#"><i class="material-icons"></i>Pages</a></li>
							<li>
								<a href="addpage">
									<i class="material-icons">create</i> Add a new page
								</a>
							</li>
							<li>
								<a href="pages">
									<i class="material-icons">pageview</i> Pages
								</a>
							</li>
							<li><a href="#"><i class="material-icons"></i>News</a></li>
							<li>
								<a href="addnew">
									<i class="material-icons">create</i> Add a new new
								</a>
							</li>
							<li>
								<a href="news">
									<i class="material-icons">pageview</i> News
								</a>
							</li>
							<li>
								<a href="../../adminlte/pages/index">
									<i class="material-icons">pageview</i> Dashboard {BETA}
								</a>
							</li>
							<!--
							<li>

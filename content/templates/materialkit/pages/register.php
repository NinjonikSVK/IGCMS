			...
			<div class="row">
    			<div class="col-md-10 col-md-offset-1">
					...
					<div class="card card-signup">
                        <h2 class="card-title text-center"><?php echo $l["registerpage"] ?></h2>
                        <div class="row">
                            <div class="col-md-5 col-md-offset-1">
            					...
            					<div class="info info-horizontal">
            						...
            						<div class="description">
            							<h4 class="info-title"><?php echo $l["register_benefits"] ?></h4>
            							<p class="description">
            								<?php echo $l["ben_1"] ?>
            							</p>
            						</div>
								...
								<form role="form" method="post" action="" autocomplete="off">
									<div class="card-content">
										...
										<div class="input-group">
											...
											<input type="email" name="email" id="email" class="form-control" placeholder=<?php echo $l["email-adress"] ?> value="<?php if(isset($error)){ echo htmlspecialchars($_POST['email'], ENT_QUOTES); } ?>" tabindex="2">
										</div>
										...
										<div class="input-group">
											...
											<input type="password" name="passwordConfirm" id="passwordConfirm" class="form-control" placeholder=<?php echo $l['passwordc'] ?> tabindex="4">
										</div>
										...
										<div class="checkbox">
											<label>
												<?php echo $l['terms'] ?><a href="tos.php"><?php echo $l["GDPR"] ?></a>.
											</label>
										</div>
									</div>
									<div class="footer text-center">

										<input type="submit" name="submit" id="submit" value=<?php echo $l["registerpage"] ?> class="btn btn-primary btn-round" tabindex="5">
									</div>
								</form>
                            </div>
                        </div>
